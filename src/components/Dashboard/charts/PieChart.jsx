  ...
  return (
    <div className='charts-pie-chart'>
      <div className='charts-pie-data'>
        <p className='dashboard-income-p'>Income: <span id='dashboard-totalincome'>{totalIncome}€</span></p>
        <p className='dashboard-expenses-p'>Expenses: <span id='dashboard-totalexpenses'>{totalExpenses}€</span></p>
      </div>
